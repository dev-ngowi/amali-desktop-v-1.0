...
class ExpensesReport(QWidget):
    ...
    def init_ui(self):
        ...
        title_label = QLabel("Expenses Report")
        ...
        self.generate_button.clicked.connect(self.generate_expenses)
        ...
        self.download_button.clicked.connect(self.download_expenses_pdf)
    ...
    def generate_expenses(self):
        ...
        expenses_data = self.report_manager.get_expenses_data(
    ...
    def download_expenses_pdf(self):
        ...
        if model is None:
            QMessageBox.warning(self, "No Data", "No expenses data to download.")
            return

        file_path, _ = QFileDialog.getSaveFileName(
            self, "Save Expenses Report as PDF", "", "PDF (*.pdf)"
        )
        ...
        if file_path:
            ...
            try:
                ...
                story.append(Paragraph("<b>Expenses Report</b>", title_style))
                ...
                for row in range(model.rowCount()):
                    ...
                    for col in range(model.columnCount()):
                        ...
                        if col in [3, 5, 6, 7]:  # Description, User, Linked Item, Store
                ...
                QMessageBox.information(
                    self, "Success", f"Expenses report downloaded to: {file_path}"
                )
