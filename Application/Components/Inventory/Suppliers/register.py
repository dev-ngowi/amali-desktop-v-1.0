...
class AddSupplierWindow(QDialog):
    ...
    def save_supplier(self):
        ...
        if supplier_data:
            try:
                supplier_id = self.supplier_manager.create_supplier(
                    supplier_data["name"],
                    supplier_data["email"],
                    supplier_data["phone"],
                    supplier_data["address"],
                    supplier_data["city_id"],
                    supplier_data["state"],
                    supplier_data["country_id"],
                    contact_person=supplier_data["contact_person"],
                    tin=supplier_data["tin"],
                    vrn=supplier_data["vrn"],
...
if __name__ == "__main__":
    ...
    window = AddSupplierWindow(supplier_manager)
    window.show()
    sys.exit(app.exec_())
